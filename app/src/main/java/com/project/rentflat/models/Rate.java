...
public class Rate implements Parcelable {
    ...
    private int rateId;
    private String userId, rateDescription, date;
    ...
    public Rate(int rateId, String userId, String rateDescription, String date, float contactRate, float descriptionRate) {
        this.rateId = rateId;
        this.userId = userId;
