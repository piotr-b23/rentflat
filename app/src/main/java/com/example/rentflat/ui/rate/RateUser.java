    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirmRate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String reportText = rateDescription.getText().toString();
                String contactRateString =Float.toString(contactBar.getRating());
                String descriptionBarString =Float.toString(descriptionBar.getRating());

                DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
                String date = df.format(Calendar.getInstance().getTime());


                giveRate(ratedUserId,raterId,contactRateString,descriptionBarString,reportText,date);
            }
        });
